...
TeaVM.wasmGC = TeaVM.wasmGC || ( () => {
    ...
    function f(e) {
        return WebAssembly.Module.imports(e).findIndex( ({module: e, name: t, kind: n}) => e === "teavm" && t === "memory" && n === "memory") >= 0
    }
    function p(e) {
    ...
    function m(o, l) {
        ...
        function A(e, t) {
            ...
            let o = r.join(", ");
            return new Function("rethrowJavaAsJs","fn",`return function(${o}) {\n` + `    try {\n` + `        return fn(${n.join(", ")});\n` + `    } catch (e) {\n` + `        rethrowJavaAsJs(e);\n` + `    }\n` + `};`)(j, e)
        }
        function C(e, t) {
            return new Function("constructor",`return function ${e}(marker, javaObject) {\n` + `    return constructor.call(this, marker, javaObject);\n` + `}\n`)(t)
        }
        o.teavmJso = {
            ...
            defineMethod(e, t, n, r) {
                ...
                let l = a.join(", ");
                e.prototype[t] = new Function("rethrowJavaAsJs","fn",`return function(${l}) {\n` + `    try {\n` + `        return fn(${["this", o].join(", ")});\n` + `    } catch (e) {\n` + `        rethrowJavaAsJs(e);\n` + `    }\n` + `};`)(j, n)
            },
        ...
        for (let e of ["wrapByte", "wrapShort", "wrapChar", "wrapInt", "wrapLong", "wrapFloat", "wrapDouble", "unwrapByte", "unwrapShort", "unwrapChar", "unwrapInt", "unwrapLong", "unwrapFloat", "unwrapDouble"]) {
            o.teavmJso[e] = d
        }
        function S(e) {
            try {
        ...
        for (let r = 0; r < 32; ++r) {
            ...
            let t = [...F, "body"].join(", ");
            o.teavmJso["createFunction" + r] = new Function("wrapCallFromJavaToJs",...F,"body",`return new Function('wrapCallFromJavaToJs', ${t}).bind(this, wrapCallFromJavaToJs);`).bind(null, S);
            o.teavmJso["bindFunction" + r] = (e, ...t) => e.bind(null, ...t);
            o.teavmJso["callFunction" + r] = new Function("rethrowJsAsJava","fn",...F,`try {\n` + `    return fn(${e});\n` + `} catch (e) {\n` + `    rethrowJsAsJava(e);\n` + `}`).bind(null, v);
            o.teavmJso["callMethod" + r] = new Function("rethrowJsAsJava","getGlobalName","instance","method",...F,`try {\n` + `    return instance !== null\n` + `        ? instance[method](${e})\n` + `        : getGlobalName(method)(${e});\n` + `} catch (e) {\n` + `    rethrowJsAsJava(e);\n` + `}`).bind(null, v, k);
            o.teavmJso["construct" + r] = new Function("rethrowJsAsJava","constructor",...F,`try {\n` + `    return new constructor(${e});\n` + `} catch (e) {\n` + `    rethrowJsAsJava(e);\n` + `}`).bind(null, v);
    ...
    async function h(e, t) {
        ...
        let[n,r] = await v(e, t);
        let o = await WebAssembly.compileStreaming(n, {
            builtins: ["js-string"]
        });
        r();
        return o
    ...
    function E() {
        if (j === null) {
            let e = new Int8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 2, 23, 1, 14, 119, 97, 115, 109, 58, 106, 115, 45, 115, 116, 114, 105, 110, 103, 4, 99, 97, 115, 116, 0, 0, 3, 1, 0, 5, 4, 1, 1, 0, 0, 10, -127, -128, -128, 0, 0]);
            j = !WebAssembly.validate(e, {
                builtins: ["js-string"]
            })
        }
        return j
    ...
    async function g(e, t, n, r) {
        ...
        let[a,l] = await v(o, n);
        const {instance: i} = await WebAssembly.instantiateStreaming(a, r, {
            builtins: ["js-string"]
        });
        l();
        return i
